...
return (
    <div className="book-wrapper">
      <div className="book-controls floating-buttons centered-buttons shadow-buttons" style={{ display: 'flex', justifyContent: 'center', gap: '1rem', marginBottom: '1rem' }}>
      ...
      <div className="page-number" style={{ textAlign: 'center', fontSize: '0.9rem', color: '#555' }}>
  Página: {currentPage}
  <br />
